...
package org.springframework.fu.module.webflux.coroutine.web.function
...
import org.springframework.fu.module.webflux.coroutine.http.codec.CoroutineHttpMessageReader
...
fun toFormData(): CoroutineBodyExtractor<MultiValueMap<String, String>?, CoroutineServerHttpRequest> =
	object : CoroutineBodyExtractor<MultiValueMap<String, String>?, CoroutineServerHttpRequest> {
		override suspend fun extract(
			inputMessage: CoroutineServerHttpRequest,
			context: CoroutineBodyExtractor.Context
...
private fun <T> messageReader(
	...
	mediaType: MediaType, context: CoroutineBodyExtractor.Context
): CoroutineHttpMessageReader<T> =
