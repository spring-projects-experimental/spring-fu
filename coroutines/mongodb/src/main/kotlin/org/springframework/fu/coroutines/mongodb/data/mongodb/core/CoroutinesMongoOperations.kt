...
package org.springframework.fu.coroutines.mongodb.data.mongodb.core
...
interface CoroutinesMongoOperations {
     ...
     */
    suspend fun <T> createCollection(entityClass: Class<T>): CoroutinesMongoCollection<Document>
     ...
     * @return the created collection
     */
    suspend fun <T> createCollection(entityClass: Class<T>, collectionOptions: CollectionOptions): CoroutinesMongoCollection<Document>
     ...
     * @return the created collection
     */
    suspend fun createCollection(collectionName: String): CoroutinesMongoCollection<Document>
     ...
     * @return the created collection
     */
    suspend fun createCollection(collectionName: String, collectionOptions: CollectionOptions): CoroutinesMongoCollection<Document>
     ...
     */
    fun getCollection(collectionName: String): CoroutinesMongoCollection<Document>
