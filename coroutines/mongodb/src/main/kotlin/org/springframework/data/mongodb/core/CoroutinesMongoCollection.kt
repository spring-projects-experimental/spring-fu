 ...
 * See [MongoCollection]
 */
interface CoroutinesMongoCollection<TDocument> {
...
) : CoroutinesMongoCollection<TDocument>

internal fun <T> MongoCollection<T>.asCoroutineMongoCollection(): CoroutinesMongoCollection<T> =
