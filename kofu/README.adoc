...
image:https://img.shields.io/badge/Kofu%20API%20documentation-blue.svg["Kofu API documentation", link="{kofu-kdoc-url}/kofu/org.springframework.fu.kofu/-application-dsl.html"]
