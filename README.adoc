...
http://repo.spring.io/milestone/org/springframework/fu/spring-boot-kofu/0.0.1/spring-boot-kofu-0.0.1-javadoc.jar!/kofu/org.springframework.boot.kofu/application.html[Kofu (for **Ko**tlin and **fu**nctional) configuration].
...
a|
http://repo.spring.io/milestone/org/springframework/fu/spring-boot-kofu/0.0.1/spring-boot-kofu-0.0.1-javadoc.jar!/kofu/org.springframework.boot.kofu/application.html[Kofu] and
 ...
 * Add the `org.springframework.fu:spring-boot-kofu:0.0.1` dependency
 ...
 * https://repo.spring.io/milestone/org/springframework/fu/bootstrap-kofu-reactive/0.0.1/bootstrap-kofu-reactive-0.0.1.zip[bootstrap-kofu-reactive.zip]
 * https://repo.spring.io/milestone/org/springframework/fu/bootstrap-kofu-coroutines/0.0.1/bootstrap-kofu-coroutines-0.0.1.zip[bootstrap-kofu-coroutines.zip]
 * https://repo.spring.io/milestone/org/springframework/fu/bootstrap-kofu-graal/0.0.1/bootstrap-kofu-graal-0.0.1.zip[bootstrap-kofu-graal.zip]
