...
Spring Fu is an experimental project designed to bring Spring support for Kotlin to the next level.

It introduces Kofu (for **Ko**tlin and **fu**nctional) configuration which allows to configure your
application with Kotlin DSL and lambdas instead of annotations,
https://jira.spring.io/browse/SPR-15413[Coroutines support] and
https://jira.spring.io/browse/SPR-16991[GraalVM native image support] to compile your application
to a native executable.

It is not intended to be used in production, but rather get feedback and contributions from the
community in order to reach a point where its features can be integrated as part of existing
