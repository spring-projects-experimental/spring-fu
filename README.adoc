...
It introduces new features like  Kofu (for **Ko**tlin and **fu**nctional) configuration which allows
to configure your application with Kotlin DSL and lambdas instead of annotations, Coroutines support
or GraalVM native image support to compile your application to a native executable.
