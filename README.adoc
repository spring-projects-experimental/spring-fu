...
http://repo.spring.io/snapshot/org/springframework/fu/spring-boot-kofu/0.0.3.BUILD-SNAPSHOT/spring-boot-kofu-0.0.3.BUILD-SNAPSHOT-javadoc.jar!/kofu/org.springframework.fu.kofu/application.html[Kofu (for **Ko**tlin and **fu**nctional) configuration].
...
a|
http://repo.spring.io/snapshot/org/springframework/fu/spring-boot-kofu/0.0.3.BUILD-SNAPSHOT/spring-boot-kofu-0.0.3.BUILD-SNAPSHOT-javadoc.jar!/kofu/org.springframework.fu.kofu/application.html[Kofu] and
