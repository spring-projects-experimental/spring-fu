Spring Fu is an incubating https://kotlinlang.org/[**Kotlin**] micro-framework that makes it easy to create lightweight https://spring.io/projects/spring-framework[Spring]-powered applications leveraging link:#functional-configuration[functional configuration].

== Overview

Spring Fu is a thin but opinionated layer on top of a subset of Spring Framework, Spring Data, Spring Security and other Spring projects that provides an alternative way than https://github.com/spring-projects/spring-boot[Spring Boot] to develop application in Kotlin:
...
* No blocking web/persistence support since Coroutines provides support imperative programming
