image:https://ci.spring.io/api/v1/teams/spring-fu/pipelines/spring-fu/jobs/build/badge["Build Status", link="https://ci.spring.io/teams/spring-fu/pipelines/spring-fu?groups=Build"]
