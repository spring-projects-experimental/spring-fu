...
* No annotation processing, minimal reflection usage and no proxies required
* Coroutines for imperative async programming and Reactive API for stream processing
...
https://github.com/sdeleuze/spring-fu/issues/29[Graal VM native image support] is planned in order to provide even faster startup time and nice deployment target for containers.
