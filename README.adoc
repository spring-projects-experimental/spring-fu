...
Fu is for **fu**nctional API, but that's also a wordplay with th -fu suffix which means skill, the Fu chinese character which means "fortune" or "good luck" and the https://en.wikipedia.org/wiki/Fu_(poetry)[chinese poetry].
