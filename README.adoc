 ...
 * https://repo.spring.io/snapshot/org/springframework/fu/bootstrap-kofu-reactive/0.0.2.BUILD-SNAPSHOT/bootstrap-kofu-reactive-0.0.2.BUILD-SNAPSHOT.zip[bootstrap-kofu-reactive.zip]
 * https://repo.spring.io/snapshot/org/springframework/fu/bootstrap-kofu-coroutines/0.0.2.BUILD-SNAPSHOT/bootstrap-kofu-coroutines-0.0.2.BUILD-SNAPSHOT.zip[bootstrap-kofu-coroutines.zip]
 * https://repo.spring.io/snapshot/org/springframework/fu/bootstrap-kofu-graal/0.0.2.BUILD-SNAPSHOT/bootstrap-kofu-graal-0.0.2.BUILD-SNAPSHOT.zip[bootstrap-kofu-graal.zip]
