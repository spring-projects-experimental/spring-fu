 ...
 * https://repo.spring.io/libs-snapshot-local/org/springframework/fu/bootstrap-kofu-reactive/0.0.1.BUILD-SNAPSHOT/bootstrap-kofu-reactive-0.0.1.BUILD-SNAPSHOT.zip[bootstrap-kofu-reactive.zip]
 * https://repo.spring.io/libs-snapshot-local/org/springframework/fu/bootstrap-kofu-coroutines/0.0.1.BUILD-SNAPSHOT/bootstrap-kofu-coroutines-0.0.1.BUILD-SNAPSHOT.zip[bootstrap-kofu-coroutines.zip]
 * https://repo.spring.io/libs-snapshot-local/org/springframework/fu/bootstrap-kofu-graal/0.0.1.BUILD-SNAPSHOT/bootstrap-kofu-graal-0.0.1.BUILD-SNAPSHOT.zip[bootstrap-kofu-graal.zip]
