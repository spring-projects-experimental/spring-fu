 ...
 * https://repo.spring.io/libs-snapshot-local/org/springframework/fu/bootstrap-reactive/0.0.1.BUILD-SNAPSHOT/bootstrap-reactive-0.0.1.BUILD-SNAPSHOT.zip[bootstrap-reactive.zip]
 * https://repo.spring.io/libs-snapshot-local/org/springframework/fu/bootstrap-coroutines/0.0.1.BUILD-SNAPSHOT/bootstrap-coroutines-0.0.1.BUILD-SNAPSHOT.zip[bootstrap-coroutines.zip]
 * https://repo.spring.io/libs-snapshot-local/org/springframework/fu/bootstrap-graal/0.0.1.BUILD-SNAPSHOT/bootstrap-graal-0.0.1.BUILD-SNAPSHOT.zip[bootstrap-graal.zip]
