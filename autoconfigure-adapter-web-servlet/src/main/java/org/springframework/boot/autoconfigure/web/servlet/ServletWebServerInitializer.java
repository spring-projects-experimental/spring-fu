...
public class ServletWebServerInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
    ...
    public ServletWebServerInitializer(
    ...
    public void initialize(GenericApplicationContext context) {
        ...
        context.registerBean(
            ...
            () -> this.webMvcProperties
        );

        context.registerBean(
            BeanPostProcessorsRegistrar.class,
            BeanPostProcessorsRegistrar::new
        );
        ...
        context.registerBean(
            ...
            () -> servletWebServerFactoryConfiguration.servletWebServerFactoryCustomizer(
                serverProperties,
                context.getBeanProvider(WebListenerRegistrar.class),
                context.getBeanProvider(CookieSameSiteSupplier.class),
        ...
        if (serverFactory instanceof TomcatServletWebServerFactory) {
            context.registerBean(
                ...
                () -> servletWebServerFactoryConfiguration.tomcatServletWebServerFactoryCustomizer(serverProperties)
            );

            context.registerBean(
                ForwardedHeaderFilterCustomizer.class,
                () -> new ForwardedHeaderFilterConfiguration().tomcatForwardedHeaderFilterCustomizer(serverProperties)
            );
        }

        context.registerBean(
            FilterRegistrationBean.class,
            () -> new ForwardedHeaderFilterConfiguration().forwardedHeaderFilter(context.getBeanProvider(ForwardedHeaderFilterCustomizer.class))
        );
        ...
        context.registerBean(
            ...
            () -> dispatcherServletConfiguration.dispatcherServlet(webMvcProperties)
        );

        context.registerBean(
            DispatcherServletAutoConfiguration.DEFAULT_DISPATCHER_SERVLET_REGISTRATION_BEAN_NAME,
            DispatcherServletRegistrationBean.class,
            () -> new DispatcherServletAutoConfiguration.DispatcherServletRegistrationConfiguration().dispatcherServletRegistration(
                context.getBean(
                    DispatcherServletAutoConfiguration.DEFAULT_DISPATCHER_SERVLET_BEAN_NAME,
                    DispatcherServlet.class
                ),
                webMvcProperties,
                context.getBeanProvider(MultipartConfigElement.class)
            )
        );
        ...
        context.registerBean(
            ...
            webMvcConfiguration::hiddenHttpMethodFilter
        );
            ...
            public WebMvcAutoConfigurationAdapter get() {
                if (configuration == null) {
                    configuration = new WebMvcAutoConfigurationAdapter(
                        ...
                        context.getBeanProvider(ResolvableType.forClass(ServletRegistrationBean.class))
                    );
        ...
        context.registerBean(
            ...
            () -> new ResourceChainCustomizerConfiguration().resourceHandlerRegistrationCustomizer(webProperties)
        );
        ...
        context.registerBean(
            ...
            () -> enableWebMvcConfiguration
                .get()
                .resourceHandlerMapping(context.getBean(ContentNegotiationManager.class),
                    context.getBean(FormattingConversionService.class),
                    context.getBean(ResourceUrlProvider.class)
                )
        );
        ...
        context.registerBean(
            ...
            () -> enableWebMvcConfiguration
                .get()
                .welcomePageHandlerMapping(context,
                    context.getBean(FormattingConversionService.class),
                    context.getBean(ResourceUrlProvider.class)
                )
        );
    ...
    private class EnableWebMvcConfigurationWrapper extends EnableWebMvcConfiguration {
        ...
        protected void configureMessageConverters(List<HttpMessageConverter<?>> converters) {
            getApplicationContext()
                .getBeanProvider(HttpMessageConverter.class)
                .orderedStream()
